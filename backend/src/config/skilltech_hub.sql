...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 09, 2026 at 07:12 AM
...
INSERT INTO `ai_conversations` (`id`, `user_id`, `course_id`, `lesson_id`, `title`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `badges` (`id`, `name`, `description`, `icon_url`, `badge_condition`, `points`, `rarity`, `created_at`) VALUES
...
INSERT INTO `forum_categories` (`id`, `name`, `slug`, `description`, `icon`, `color`, `sort_order`, `post_count`) VALUES
...
INSERT INTO `forum_posts` (`id`, `category_id`, `user_id`, `parent_id`, `title`, `body`, `type`, `vote_count`, `reply_count`, `view_count`, `is_pinned`, `is_answered`, `is_deleted`, `tags`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `forum_votes` (`id`, `post_id`, `user_id`, `value`) VALUES
...
INSERT INTO `live_sessions` (`id`, `course_id`, `instructor_id`, `title`, `description`, `scheduled_at`, `duration_min`, `status`, `livekit_room_id`, `rtmp_key`, `recording_url`, `thumbnail_url`, `max_participants`, `current_participants`, `is_recorded`, `is_public`, `price`, `started_at`, `ended_at`, `created_at`) VALUES
...
INSERT INTO `schools` (`id`, `name`, `slug`, `description`, `icon`, `color`, `is_active`, `sort_order`, `created_at`) VALUES
