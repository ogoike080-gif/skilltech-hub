...
const { protect, requireInstructor, requireApprovedInstructor, requireEnrollment, optionalAuth } = require('../middleware/auth');
...
router.post('/',                           protect, requireApprovedInstructor, upload.single('thumbnail'), ctrl.createCourse);
