...
const API_URL =
  ...
  'https://skilltech-hub-production.up.railway.app'; // ✅ corrected fallback (no "backend-")
...
if (!import.meta.env.VITE_API_URL) {
  console.warn(
    '⚠️ VITE_API_URL was NOT injected at build time — using hardcoded fallback. ' +
    'Check that VITE_API_URL is set on the Railway FRONTEND service and that a fresh build ran.'
  );
}
